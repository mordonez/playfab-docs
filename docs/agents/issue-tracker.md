...
- **Blocking**: use GitHub’s native issue dependencies, falling back to a `Blocked by:` line when unavailable.
- **Frontier query**: select the first unassigned, unblocked, open child in map order.
